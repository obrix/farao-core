...
public class BranchCnecSerializer<I extends BranchCnec> extends JsonSerializer<I> {
    ...
    public void serialize(I branchCnec, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        ...
        jsonGenerator.writeObjectField(RM, branchCnec.getReliabilityMargin());
        JsonUtil.writeExtensions(branchCnec, jsonGenerator, serializerProvider, ExtensionsHandler.getExtensionsSerializers());
    }

    @Override
    public void serializeWithType(I branchCnec, JsonGenerator jsonGenerator, SerializerProvider serializerProvider, TypeSerializer typeSerializer) throws IOException {
        WritableTypeId writableTypeId = typeSerializer.typeId(branchCnec, JsonToken.START_OBJECT);
        typeSerializer.writeTypePrefix(jsonGenerator, writableTypeId);
        serialize(branchCnec, jsonGenerator, serializerProvider);
